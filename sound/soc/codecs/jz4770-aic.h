...
#ifndef __JZ4770_AIC_H__
#define __JZ4770_AIC_H__
...
#define	AIC_FR_RFTH_MASK	GENMASK(27, AIC_FR_RFTH_LSB)

#define	AIC_FR_TFTH_LSB		16
#define	AIC_FR_TFTH_MASK	GENMASK(20, AIC_FR_TFTH_LSB)

/* new@4770 */
#define AIC_FR_IBCKD		BIT(10)

/* new@4770 */
#define AIC_FR_ISYNCD		BIT(9)

/* new@4770 */
#define IC_FR_DMODE		BIT(8)

#define	AIC_FR_LSMP		BIT(6)
#define	AIC_FR_ICDC		BIT(5)
#define	AIC_FR_AUSEL		BIT(4)
#define	AIC_FR_RST		BIT(3)
#define	AIC_FR_BCKD		BIT(2)
#define	AIC_FR_SYNCD		BIT(1)
#define	AIC_FR_ENB		BIT(0)


/* AIC_CR definition */
#define AIC_CR_PACK16		BIT(28)

#define AIC_CR_CHANNEL_LSB	24
#define AIC_CR_CHANNEL_MASK	GENMASK(26, 24)

#define	AIC_CR_OSS_LSB		19
#define	AIC_CR_OSS_MASK		GENMASK(21, AIC_CR_OSS_LSB)
#define AIC_CR_OSS(n)		(((n) > 18 ? (n)/6 : (n)/9) << AIC_CR_OSS_LSB)	/* n = 8, 16, 18, 20, 24 */

#define	AIC_CR_ISS_LSB		16
#define	AIC_CR_ISS_MASK		GENMASK(18, AIC_CR_ISS_LSB)
#define AIC_CR_ISS(n)		(((n) > 18 ? (n)/6 : (n)/9) << AIC_CR_ISS_LSB)	/* n = 8, 16, 18, 20, 24 */

#define	AIC_CR_RDMS		BIT(15)
#define	AIC_CR_TDMS		BIT(14)
#define	AIC_CR_M2S		BIT(11)
#define	AIC_CR_ENDSW		BIT(10)
#define	AIC_CR_AVSTSU		BIT(9)
#define	AIC_CR_TFLUSH		BIT(8)
#define	AIC_CR_RFLUSH		BIT(7)
#define	AIC_CR_EROR		BIT(6)
#define	AIC_CR_ETUR		BIT(5)
#define	AIC_CR_ERFS		BIT(4)
#define	AIC_CR_ETFS		BIT(3)
#define	AIC_CR_ENLBF		BIT(2)
#define	AIC_CR_ERPL		BIT(1)
#define	AIC_CR_EREC		BIT(0)

/* AIC controller AC-link control register 1(ACCR1) */
#define AIC_ACCR1_RS_LSB	16
#define	AIC_ACCR1_RS_MASK	GENMASK(25, AIC_ACCR1_RS_LSB)
 #define AIC_ACCR1_RS_SLOT(n)	((1 << ((n) - 3)) << AIC_ACCR1_RS_LSB)	/* n = 3 .. 12 */

#define AIC_ACCR1_XS_LSB	0
#define	AIC_ACCR1_XS_MASK	GENMASK(9, AIC_ACCR1_XS_LSB)
 #define AIC_ACCR1_XS_SLOT(n)	((1 << ((n) - 3)) << AIC_ACCR1_XS_LSB)	/* n = 3 .. 12 */

/* AIC controller AC-link control register 2 (ACCR2) */
#define	AIC_ACCR2_ERSTO		BIT(18)
#define	AIC_ACCR2_ESADR		BIT(17)
#define	AIC_ACCR2_ECADT		BIT(16)
#define	AIC_ACCR2_SO		BIT(3)
#define	AIC_ACCR2_SR		BIT(2)
#define	AIC_ACCR2_SS		BIT(1)
#define	AIC_ACCR2_SA		BIT(0)

/* AIC controller i2s/msb-justified control register (I2SCR) */
#define	AIC_I2SCR_RFIRST	BIT(17)
#define	AIC_I2SCR_SWLH   	BIT(16)
#define AIC_I2SCR_ISTPBK	BIT(13)
#define	AIC_I2SCR_STPBK		BIT(12)
#define AIC_I2SCR_ESCLK		BIT(4)
#define	AIC_I2SCR_AMSL		BIT(0)

/* AIC controller FIFO status register (AICSR) */
#define	AIC_SR_RFL_LSB		24
#define	AIC_SR_RFL_MASK		GENMASK(29, AIC_SR_RFL_LSB)

#define	AIC_SR_TFL_LSB		8
#define	AIC_SR_TFL_MASK		GENMASK(13, AIC_SR_TFL_LSB)

#define	AIC_SR_ROR		BIT(6)
#define	AIC_SR_TUR		BIT(5)
#define	AIC_SR_RFS		BIT(4)
#define	AIC_SR_TFS		BIT(3)

/* AIC controller AC-link status register (ACSR) */
#define	AIC_ACSR_SLTERR		BIT(21)
#define	AIC_ACSR_CRDY		BIT(20)
#define	AIC_ACSR_CLPM		BIT(19)
#define	AIC_ACSR_RSTO		BIT(18)
#define	AIC_ACSR_SADR		BIT(17)
#define	AIC_ACSR_CADT		BIT(16)

/* AIC controller I2S/MSB-justified status register (I2SSR) */
#define	AIC_I2SSR_CHBSY		BIT(5)
#define	AIC_I2SSR_TBSY		BIT(4)
#define	AIC_I2SSR_RBSY		BIT(3)
#define	AIC_I2SSR_BSY		BIT(2)

/* AIC controller AC97 codec command address register (ACCAR) */
#define	AIC_ACCAR_CAR_LSB	0
#define	AIC_ACCAR_CAR_MASK	GENMASK(19, AIC_ACCAR_CAR_LSB)


/* AIC controller AC97 codec command data register (ACCDR) */
#define	AIC_ACCDR_CDR_LSB	0
#define	AIC_ACCDR_CDR_MASK	GENMASK(19, AIC_ACCDR_CDR_LSB)

/* AC97 read and write macro based on ACCAR and ACCDR */
#define AC97_READ_CMD		BIT(19)
#define AC97_WRITE_CMD		(BIT(19) & ~BIT(19))

#define AC97_INDEX_LSB		12
#define AC97_INDEX_MASK		GENMASK(18, AC97_INDEX_LSB)

#define AC97_DATA_LSB		4
#define AC97_DATA_MASK		GENMASK(19, AC97_DATA_LSB)

/* AIC controller AC97 codec status address register (ACSAR) */
#define	AIC_ACSAR_SAR_LSB	0
#define	AIC_ACSAR_SAR_MASK	GENMASK(19, AIC_ACSAR_SAR_LSB)

/* AIC controller AC97 codec status data register (ACSDR) */
#define	AIC_ACSDR_SDR_LSB	0
#define	AIC_ACSDR_SDR_MASK	GENMASK(19, AIC_ACSDR_SDR_LSB)

/* AIC controller I2S/MSB-justified clock divider register (I2SDIV) */
#define AIC_I2SDIV_IDIV_LSB	8
#define AIC_I2SDIV_IDIV_MASK	GENMASK(11, AIC_I2SDIV_IDIV_LSB)
#define	AIC_I2SDIV_DIV_LSB	0
#define	AIC_I2SDIV_DIV_MASK	GENMASK(3, AIC_I2SDIV_DIV_LSB)

/* SPDIF enable register (SPDIF_ENA) */
#define SPDIF_ENA_SPEN		BIT(0)

/* SPDIF control register (SPDIF_CTRL) */
#define SPDIF_CTRL_DMAEN        BIT(15)
#define SPDIF_CTRL_DTYPE        BIT(14)
#define SPDIF_CTRL_SIGN         BIT(13)
#define SPDIF_CTRL_INVALID      BIT(12)
#define SPDIF_CTRL_RST          BIT(11)
#define SPDIF_CTRL_SPDIFI2S     BIT(10)
#define SPDIF_CTRL_MTRIG        BIT(1)
#define SPDIF_CTRL_MFFUR        BIT(0)

/* SPDIF state register (SPDIF_STAT) */
#define SPDIF_STAT_BUSY		BIT(7)
#define SPDIF_STAT_FTRIG	BIT(1)
#define SPDIF_STAT_FUR		BIT(0)

#define SPDIF_STAT_FLVL_LSB	8
#define SPDIF_STAT_FLVL_MASK	GENMASK(14, SPDIF_STAT_FLVL_LSB)

/* SPDIF configure 1 register (SPDIF_CFG1) */
#define SPDIF_CFG1_INITLVL	BIT(17)
#define SPDIF_CFG1_ZROVLD	BIT(16)

#define SPDIF_CFG1_TRIG_LSB	12
#define SPDIF_CFG1_TRIG_MASK	GENMASK(13, SPDIF_CFG1_TRIG_LSB)
#define SPDIF_CFG1_TRIG(n)	(((n) > 16 ? 3 : (n)/8) << SPDIF_CFG1_TRIG_LSB)	/* n = 4, 8, 16, 32 */

#define SPDIF_CFG1_SRCNUM_LSB	8
#define SPDIF_CFG1_SRCNUM_MASK	GENMASK(11, SPDIF_CFG1_SRCNUM_LSB)

#define SPDIF_CFG1_CH1NUM_LSB	4
#define SPDIF_CFG1_CH1NUM_MASK	GENMASK(7, SPDIF_CFG1_CH1NUM_LSB)

#define SPDIF_CFG1_CH2NUM_LSB	0
#define SPDIF_CFG1_CH2NUM_MASK	GENMASK(3, SPDIF_CFG1_CH2NUM_LSB)

/* SPDIF configure 2 register (SPDIF_CFG2) */
#define SPDIF_CFG2_MAXWL	BIT(18)
#define SPDIF_CFG2_PRE		BIT(3)
#define SPDIF_CFG2_COPYN	BIT(2)
#define SPDIF_CFG2_AUDION	BIT(1)
#define SPDIF_CFG2_CONPRO	BIT(0)

#define SPDIF_CFG2_FS_LSB	26
#define SPDIF_CFG2_FS_MASK	GENMASK(29, SPDIF_CFG2_FS_LSB)

#define SPDIF_CFG2_ORGFRQ_LSB	22
#define SPDIF_CFG2_ORGFRQ_MASK	GENMASK(25, SPDIF_CFG2_ORGFRQ_LSB)

#define SPDIF_CFG2_SAMWL_LSB	19
#define SPDIF_CFG2_SAMWL_MASK	GENMASK(21, SPDIF_CFG2_SAMWL_LSB)

#define SPDIF_CFG2_CLKACU_LSB	16
#define SPDIF_CFG2_CLKACU_MASK	GENMASK(17, SPDIF_CFG2_CLKACU_LSB)

#define SPDIF_CFG2_CATCODE_LSB	8
#define SPDIF_CFG2_CATCODE_MASK	GENMASK(15, SPDIF_CFG2_CATCODE_LSB)

#define SPDIF_CFG2_CHMD_LSB	6
#define SPDIF_CFG2_CHMD_MASK	GENMASK(7, SPDIF_CFG2_CHMD_LSB)
