...
static int __devinit jz4770_i2s_dev_probe(struct platform_device *pdev)
{
	...
	*/
	...
	ret = snd_soc_register_dai(&pdev->dev, &jz4770_i2s_dai);
	if (ret) {
...
static int __devexit jz4770_i2s_dev_remove(struct platform_device *pdev)
{
...
static struct platform_driver jz4770_i2s_driver = {
	...
	.remove = __devexit_p(jz4770_i2s_dev_remove),
	.driver = {
		.name = "jz4770-i2s",
		.owner = THIS_MODULE,
	},
