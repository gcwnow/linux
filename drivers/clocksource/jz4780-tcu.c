...
static struct jz47xx_tcu_channel_desc jz4780_tcu_channels[8] = {
	[0] = JZ47XX_TCU_CHANNEL(1),
	[1] = JZ47XX_TCU_CHANNEL(1),
	[2] = JZ47XX_TCU_CHANNEL(1),
	[3] = JZ47XX_TCU_CHANNEL(1),
	[4] = JZ47XX_TCU_CHANNEL(1),
	[5] = JZ47XX_TCU_CHANNEL(0),
	[6] = JZ47XX_TCU_CHANNEL(1),
	[7] = JZ47XX_TCU_CHANNEL(1),
};
