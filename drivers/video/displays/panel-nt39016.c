...
static const u16 panel_data[] = {
	RV(0x01, 0x00), RV(0x02, 0x03), RV(0x03, 0xCC), RV(0x04, 0x46),
	RV(0x05, 0x0D), RV(0x06, 0x00), RV(0x07, 0x00), RV(0x08, 0x08),
	RV(0x09, 0x40), RV(0x0A, 0x88), RV(0x0B, 0x88), RV(0x0C, 0x20),
	RV(0x0D, 0x20), RV(0x0E, 0x67), RV(0x0F, 0xA4), RV(0x10, 0x04),
	RV(0x11, 0x24), RV(0x12, 0x24), RV(0x1E, 0x67), RV(0x20, 0x00),
};
#undef RV
...
static int __devinit nt39016_panel_init(void **out_panel,
...
static void __devexit nt39016_panel_exit(void *panel)
{
}
