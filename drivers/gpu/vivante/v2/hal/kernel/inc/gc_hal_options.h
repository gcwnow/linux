...
*/
#ifndef gcdMMU_SIZE
#   if defined(CONFIG_MACH_JZ4770) && ANDROID
...
/*
    ...
    This define enables/disables the power management code.
*/
#if defined(gcdPOWER_MANAGEMENT)
#   ifdef gcdNO_POWER_MANAGEMENT
#      error "Can't define both gcdPOWER_MANAGEMENT and gcdNO_POWER_MANAGEMENT"
#   endif
#   define gcdNO_POWER_MANAGEMENT !gcdPOWER_MANAGEMENT
#elif defined(gcdNO_POWER_MANAGEMENT)
#   define gcdPOWER_MANAGEMENT !gcdNO_POWER_MANAGEMENT
#else
